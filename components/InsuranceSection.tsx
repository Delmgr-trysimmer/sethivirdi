    ...
    return (
        <section className="w-full bg-white pb-16 md:pb-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1290px]">
                <div className="w-full bg-[#d0eeff] rounded-t-2xl py-12 px-6 md:px-12 text-center text-[#0d0d0d]">
                    <h2 className="text-[28px] md:text-[32px] font-semibold mb-4 tracking-tight " text-shadow="0px 0px 10px rgba(0, 0, 0, .3)">
