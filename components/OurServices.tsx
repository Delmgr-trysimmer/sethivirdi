                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="mt-3 text-[16px] leading-[1.6] text-[#4a4a4a] line-clamp-5">
                                        {service.description}
                                    </p>
                                    <span className="mt-5 inline-flex rounded-full bg-[#1291da] px-5 py-3 text-[15px] font-semibold text-white transition-colors duration-300 hover:bg-[#0f7dbd]">
                                        Learn More
                                    </span>
                                </div>
                            </Link>
